...
const Left=()=>{
	return(
		<div className={css.Left}>
			...
			<Link className={css.Link} to='/ebooks/CSITSixth/compiler-OldQuestion/2065'><div className={css.Body}>Old Questions 2065</div></Link>
			<Link className={css.Link} to='/ebooks/CSITSixth/compiler-OldQuestion/2066'><div className={css.Body}>Old Questions 2066</div></Link>
			<Link className={css.Link} to='/ebooks/CSITSixth/compiler-OldQuestion/2067'><div className={css.Body}>Old Questions 2067</div></Link>
			...
			<Link className={css.Link} to='/ebooks/CSITSixth/compiler-OldQuestion/2075'><div className={css.Body}>Old Questions 2075</div></Link>
		</div>
		)
}
export default Left