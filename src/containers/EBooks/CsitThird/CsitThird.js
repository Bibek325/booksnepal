...
import css from './CsitThird.css'
class CsitThird extends Component{
	state={
		subjects:[{name:'Data Structure and Algorithm (CSC 206)',Branch1:{label:'old Question',value:"/ebooks/CsitThird/DSA-OldQuestion"},Branch2:{label:'Past Question',value:'www.fb.com'}},
